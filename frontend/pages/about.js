    ...
    <div className="one-column-grid">
      <div>
        ...
        <p>
          ...
          reason to the view and that you can't click or share anything - just a
          place to recognize the beauty and effort all these talented humans put
          into making art that the rain strips away.
        </p>
        <p>
